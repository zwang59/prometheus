...
def ANN_model(data):
    ...
    mlp = MLPClassifier(hidden_layer_sizes=gcv.best_params_['hidden_layer_sizes'], activation=gcv.best_params_['activation'], alpha=gcv.best_params_['alpha'], max_iter=6000)
