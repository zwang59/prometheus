...
def KNN_Class_model(data):
    ...
    KNN_Class_model = neighbors.KNeighborsClassifier(n_neighbors=grid_search.best_params_['n_neighbors'], p=grid_search.best_params_['p'], weights=grid_search.best_params_['weights'])
...
def KNN_Reg_model(data):
    ...
    KNN_Reg_model = neighbors.KNeighborsRegressor(n_neighbors=grid_search.best_params_['n_neighbors'], p=grid_search.best_params_['p'], weights=grid_search.best_params_['weights']) 
